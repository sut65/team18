...
async function GetNotify() {
  ...
  let res = await fetch(`${apiUrl}/notifys`, requestOptions)
    .then((response) => response.json())
    .then((res) => {
      if (res.data) {
        return res.data;
...
async function GetNotifyID(id: any) {
  const requestOptions = {
    method: "GET",
    headers: {
      Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  let res = await fetch(`${apiUrl}/notify/${id}`, requestOptions)
    .then((response) => response.json())
    .then((res) => {
      if (res.data) {
        return res.data;
...
async function ListNotifybyMember(id: any) {
  const requestOptions = {
    method: "GET",
    headers: {
      Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  let res = await fetch(`${apiUrl}/notifymb/${id}`, requestOptions)
    .then((response) => response.json())
    .then((res) => {
      if (res.data) {
        return res.data;
...
//---------------------update--------------------------------------
async function UpdateNotify(data: NotifyInterface) {
  const requestOptions = {
    method: "PUT",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data),
